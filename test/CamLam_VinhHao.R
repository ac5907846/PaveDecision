CamLam_VinhHao_inputs <- function(session) {
  observeEvent(session$input$CamLam_VinhHao_button, {
#################
# Flexible Inputs
#################
    hide("Eyc_special")
    ...
    updateNumericInput(session, "road_length", value = 78.5)
    updateNumericInput(session, "design_year", value = 15)
    updateNumericInput(session, "Total_Axle_Ntk", value = 1891)
    updateNumericInput(session, "Vehicle_Growth_q", value = 0.0867)
    updateNumericInput(session, "Total_Axle_Ne", value = 2157953)
    ...
    updateNumericInput(session, "sbase1_h", value = 16)
    ...
    updateNumericInput(session, "base_Edel", value = 350)
    ...
    updateNumericInput(session, "base_Rku", value = 2.0)
...
# Rigid Inputs
##############
    updateNumericInput(session, "Depth_hc", value = 31)
...
# Economics
###########
    updateNumericInput(session, "f_pave1_unitcost", value = 126.01)
    updateNumericInput(session, "f_pave2_unitcost", value = 115.30)
    updateNumericInput(session, "f_base_unitcost", value = 96.09)
    updateNumericInput(session, "f_sbase1_unitcost", value = 36.58)
    updateNumericInput(session, "f_sbase2_unitcost", value = 26.42)
    updateNumericInput(session, "f_bonding_unitcost", value = 0.51)
    
    updateNumericInput(session, "r_pave_unitcost", value = 99.21)
    updateNumericInput(session, "r_base_unitcost", value = 41.80)
    updateNumericInput(session, "r_subbase_unitcost", value = 26.42)
    updateNumericInput(session, "r_long_joint_unitcost", value = 9.41)
    updateNumericInput(session, "r_tran_joint_unitcost", value = 6.62)
    
    updateNumericInput(session, "f.ir", value = 0.0776)
    updateNumericInput(session, "r.ir", value = 0.0776)
